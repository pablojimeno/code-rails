...
Add a Gemfile to the project you started in the last step to manage the gems on which it depends. Include the rake gem to get started.
...
Use BDD to develop a simple HTML page. You can create an html page with your text editor.
...
**OR** you can create a serve.sh file, and make it executable. Example [here](https://gist.github.com/ivanoats/6613386)
