...
* [Chapter 3: Rails Resources](chapter_3_rails_resources/README.md)
   * [Read: Intro to CRUD](chapter_3_rails_resources/read_intro_to_crud.md)
   * [Read: Rails Getting Started Guide Sections 5 - 6](chapter_3_rails_resources/read_rails_getting_started_guide_sections_5_-_6.md)
   * [Read: Code Fellows Alumnus' Blog Post on MVC and Scaffolding](chapter_3_rails_resources/read_code_fellows_alumnus_blog_post_on_mvc_and_scaffolding.md)
   * [Watch: Minitest Overview and RailsCast on Minitest with Rails](chapter_3_rails_resources/watch_minitest_overview_and_railscast_on_minitest_with_rails.md)
   * [RED](chapter_3_rails_resources/red.md)
       ...
       * [As the site owner, I want to write a post so that I can show my expertise](chapter_3_rails_resources/as_the_site_owner,_i_want_to_write_a_post_so_that_i_can_show_my_expertise.md)
       * [As the site owner, I want to edit a post so that I can correct typos](chapter_3_rails_resources/as_the_site_owner,_i_want_to_edit_a_post_so_that_i_can_correct_typos.md)
       * [As the site owner, I want to delete a post so that I can remove drunken rants](chapter_3_rails_resources/as_the_site_owner,_i_want_to_delete_a_post_so_that_i_can_remove_drunken_rants.md)
   * [GREEN](chapter_3_rails_resources/green.md)
       * [Generate a Post scaffold](chapter_3_rails_resources/generate_a_post_scaffold.md)
